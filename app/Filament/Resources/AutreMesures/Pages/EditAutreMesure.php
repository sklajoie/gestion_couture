...
class EditAutreMesure extends EditRecord
{
...
{
    $this->ancienCouture = ProduitCouture::where('autre_mesure_id', $this->record->id)->get()->keyBy('produit_id');
...
foreach ($etapes as $etapeId => $etapeData) {
    ...
    $this->record->etapeMesures()->updateOrCreate(
        ...
        [
            ...
            'montant' => $etapeData['montant']?? null,
        ]
    );     
