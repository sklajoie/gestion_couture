...
class AtelierPolicy
{
    ...
    {
        return $user->hasPermissionTo('Voir Atelier');
    }
    ...
    {
       return $user->hasPermissionTo('Ajouter Atelier');
    }
    ...
    {
        return $user->hasPermissionTo('Edite Atelier');
    }
    ...
    {
       return $user->hasPermissionTo('Supprimer Atelier');
    }
