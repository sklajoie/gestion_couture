...
class EmployePolicy
{
    ...
    {
        return $user->hasPermissionTo('Voir Employes');
    }
    ...
    {
        return $user->hasPermissionTo('Ajouter Employes');
    }
    ...
    {
        return $user->hasPermissionTo('Edite Employes');
    }
    ...
    {
       return $user->hasPermissionTo('Supprimer Employes');
    }
