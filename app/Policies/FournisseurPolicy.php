...
class FournisseurPolicy
{
    ...
    {
        return $user->hasPermissionTo('Voir Fournisseur');
    }
    ...
    {
        return $user->hasPermissionTo('Ajouter Fournisseur');
    }
    ...
    {
        return $user->hasPermissionTo('Edite Fournisseur');
    }
    ...
    {
       return $user->hasPermissionTo('Supprimer Fournisseur');
    }
